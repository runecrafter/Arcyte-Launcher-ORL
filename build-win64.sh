...
cp native/build-x64/src/Release/Arcyte.exe build/win-x64/
cp target/Arcyte.jar build/win-x64/
...
echo Arcyte.exe 64bit sha256sum
sha256sum build/win-x64/Arcyte.exe

dumpbin //HEADERS build/win-x64/Arcyte.exe
