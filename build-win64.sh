...
cp native/build-x64/src/Release/Daeyalt.exe build/win-x64/
cp target/Daeyalt.jar build/win-x64/
...
sha256sum build/win-x64/Daeyalt.exe

dumpbin //HEADERS build/win-x64/Daeyalt.exe
